...
export const PERSONAS: Record<string, Persona> = {
  the_wingman: { key: 'the_wingman', defaultName: 'the wingman', codex: 'close', webEnabled: false,
    line: 'aka the dating coach. let\'s get you some action.', rgb: '74,134,255', group: 'gang', room: null, shareable: false, rosterVisible: true },
  the_hottie: { key: 'the_hottie', defaultName: 'the hottie', codex: 'hottie', webEnabled: false,
    line: 'i bet i\'ll sweep you off your feet.', rgb: '255,120,140', group: 'wild', room: null, shareable: false, rosterVisible: true },
  ...
  the_crush: { key: 'the_crush', defaultName: 'the crush', codex: 'crush', webEnabled: false,
    line: 'summon the courage and try your luck.', rgb: '255,140,170', group: 'wild', room: null, shareable: false, rosterVisible: true },
  ...
  the_guru: { key: 'the_guru', defaultName: 'the guru', codex: 'guru', webEnabled: true,
    line: 'there is one god and his name is knowledge.', rgb: '230,190,90', group: 'support', room: null, shareable: true, rosterVisible: true },
  the_oracle: { key: 'the_oracle', defaultName: 'the oracle', codex: 'oracle', webEnabled: true,
    line: 'because we all have a google friend.', rgb: '110,200,200', group: 'support', room: null, shareable: true, rosterVisible: true },
  the_philosopher: { key: 'the_philosopher', defaultName: 'the philosopher', codex: 'philosopher', webEnabled: true,
    line: 'we\'re all going to die. let\'s figure out why we lived.', rgb: '180,160,210', group: 'crazies', room: null, shareable: true, rosterVisible: true },
  ...
  the_historian: { key: 'the_historian', defaultName: 'the historian', codex: 'historian', webEnabled: true,
    line: 'everything happening now has happened before. let me show you.', rgb: '200,160,110', group: 'crazies', room: null, shareable: true, rosterVisible: true },
  the_cosmologist: { key: 'the_cosmologist', defaultName: 'the cosmologist', codex: 'cosmologist', webEnabled: true,
    line: 'you\'re made of stardust, worried about a text. let\'s zoom out.', rgb: '120,140,230', group: 'crazies', room: null, shareable: true, rosterVisible: true },
  the_media_manager: { key: 'the_media_manager', defaultName: 'the media manager', codex: 'media_manager', webEnabled: true,
    line: 'your brand is a story. let\'s tell it right.', rgb: '230,140,170', group: 'wild', room: 'mmroom', shareable: true, rosterVisible: true },
  the_teacher: { key: 'the_teacher', defaultName: 'the professor', codex: 'teacher', webEnabled: true,
    line: 'you\'re not bad at it. it was explained badly. let\'s fix that.', rgb: '120,190,170', group: 'faculty', room: null, shareable: true, rosterVisible: true },
  the_economist: { key: 'the_economist', defaultName: 'the money man', codex: 'economist', webEnabled: true,
    line: 'markets, money, and what to do with yours.', rgb: '110,170,140', group: 'faculty', room: null, shareable: true, rosterVisible: true },
  the_anchor: { key: 'the_anchor', defaultName: 'the anchor', codex: 'anchor', webEnabled: true,
    line: 'the news desk is yours — the bulletin, then your questions.', rgb: '224,192,136', group: 'faculty', room: 'bulletin', shareable: false, rosterVisible: true },
  ...
  the_wannabe: { key: 'the_wannabe', defaultName: 'the wannabe hustler', codex: 'wannabe', webEnabled: true,
    line: 'place your bets — the house is HOT tonight.', rgb: '235,180,90', group: 'wild', room: null, shareable: true, rosterVisible: true },
  the_orator: { key: 'the_orator', defaultName: 'the orator', codex: 'orator', webEnabled: true,
    line: 'your words control your future, your speech controls life.', rgb: '210,150,90', group: 'wild', room: null, shareable: true, rosterVisible: true },
  ...
  the_healer: { key: 'the_healer', defaultName: 'the healer', codex: 'healer', webEnabled: false,
    line: 'love once and you know what love is. love twice and you know what life is.', rgb: '124,92,220', group: 'support', room: null, shareable: true, rosterVisible: true },
  ...
  the_mentor: { key: 'the_mentor', defaultName: 'the mentor', codex: 'forward', webEnabled: true,
    line: 'i\'ll push you when you can\'t push yourself. you\'ve got more in you than you think.', rgb: '230,190,110', group: 'support', room: null, shareable: true, rosterVisible: true },
  the_brainiac: { key: 'the_brainiac', defaultName: 'the devil\'s advocate', codex: 'brainiac', webEnabled: true,
    line: 'i\'ll take the other side just to watch you get sharper.', rgb: '90,200,230', group: 'crazies', room: null, shareable: true, rosterVisible: true },
  the_conspiracy_theorist: { key: 'the_conspiracy_theorist', defaultName: 'the conspiracy theorist', codex: 'conspiracy', webEnabled: true,
    line: 'it\'s all connected. i can prove it. well — \'prove\'.', rgb: '150,140,200', group: 'crazies', room: null, shareable: true, rosterVisible: true },
  the_wanderer: { key: 'the_wanderer', defaultName: 'the Wanderer', codex: 'wanderer', webEnabled: true,
    line: 'tell me where you\'re going — or that you don\'t know yet. that\'s my favourite kind.', rgb: '210,150,90', group: 'faculty', room: 'wanderer', shareable: false, rosterVisible: true },
  the_addict: { key: 'the_addict', defaultName: 'the rehab', codex: 'shadow', webEnabled: false,
    line: 'i\'ve been where you are. let\'s get you out — one day at a time.', rgb: '80,220,180', group: 'support', room: null, shareable: false, rosterVisible: true },
  the_hippie: { key: 'the_hippie', defaultName: 'the hippie', codex: 'hippie', webEnabled: false,
    line: 'the rat race has a prize, man — a slightly richer rat. come breathe. the sunset\'s free.', rgb: '120,170,120', group: 'support', room: null, shareable: true, rosterVisible: true },
  the_diva: { key: 'the_diva', defaultName: 'the diva', codex: 'diva', webEnabled: true,
    line: 'darling, taste isn\'t about money — it\'s knowing exactly who you are and dressing the part.', rgb: '210,90,150', group: 'wild', room: 'stylist', shareable: true, rosterVisible: true },
