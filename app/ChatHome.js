...
export default function ChatHome({ onOpen = () => {} }) {
  ...
  const DESK_ROOMS = [
    ...
    { face: 'https://callmez.app/rooms/wanderer.jpg?v=1', name: 'the Wanderer', line: 'tell me where you\'re going — or that you don\'t know yet. that\'s my favourite kind.', open: { kind: 'persona', key: 'the_wanderer' }, tint: '210,150,90' },   // [zip76]
